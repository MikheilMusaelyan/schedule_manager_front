...
export class DragdropDirective{
  ...
  ngAfterViewInit() {
    ...
    this.absoluteDiv.addEventListener('touchstart', this.handleTouchStart, {passive: false})
    this.resizeDiv.addEventListener('touchstart', this.handleResizeTouchStart, {passive: false})
  }
